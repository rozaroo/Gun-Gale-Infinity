...
Shader "CampodeFuerza"
{
	...
	SubShader
	{
		...
		{
			float4 color10 = IsGammaSpace() ? float4(0,0.8140439,0.7088585,0) : float4(0,0.6279055,0.4607074,0);
...
/*ASEBEGIN
Version=18900
0;0;1351.918;709.3918;1012.889;440.3811;2.086873;False;False
...
Node;AmplifyShaderEditor.ColorNode;10;-508.0368,-183.9923;Inherit;False;Constant;_Color0;Color 0;1;0;Create;True;0;0;0;False;0;False;0,0.8140439,0.7088585,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=B10C493D530C2384C86E3943C8F3A46F12CFEE04